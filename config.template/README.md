...
- `subject.md` · who or what is being read, and which domains count. **You write this**, guided by worked examples and the questions to ask yourself. ~15 minutes.
- `corpus.md` · which sources may be read, where they are, what is known to be missing. **You write this**, guided by a table of where to look (assistant chat history, working folders, repositories, CRM, sent mail, calendar, finance) with the usual file paths. ~30 minutes.
